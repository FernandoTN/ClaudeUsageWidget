...
| 4.1 `CodexResetsCard` in the Overview (count never claims zero, on-demand details by expiry, Redeem gated on a measured limit with confirmation and outcome) | `feat/ux-revamp-r3-design-pass` | draft | spec §12.9 + the I1–I5 insights copy items; the deploy point |
