...
| 4b `DashboardInsightsView` (eight sections, timeline strip, sparkline, `InsightsFormatting`, `FleetInsights.fixture`) — the redesign embeds it under the last section | `feat/ux-revamp-4b-insights-view` | draft | design pass §12.7 |
